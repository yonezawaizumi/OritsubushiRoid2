...
public abstract class PreferenceFragment extends ListFragment {
    ...
    private static class MyHandler extends Handler {
    	private WeakReference<PreferenceFragment> fragment;
    	private MyHandler(PreferenceFragment fragment) {
    		this.fragment = new WeakReference<PreferenceFragment>(fragment);
    	}
    	@Override
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_BIND_PREFERENCES:
                	PreferenceFragment fragment = this.fragment.get();
                	if(fragment != null) {
    ...
    public void onCreate(Bundle b) {
        ...
        lv = (ListView) LayoutInflater.from(getActivity()).inflate(getLayoutId(), null);
