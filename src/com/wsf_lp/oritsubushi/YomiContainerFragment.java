...
public class YomiContainerFragment extends GroupFragmentBase {
	...
	@Override
	protected boolean updateGroups(int panelIndex, String MethodName,
			Object result) {
		// TODO 自動生成されたメソッド・スタブ
		return false;
	}
	...
	@Override
	protected boolean updateHeader(int panelIndex, String MethodName,
			Object result) {
		// TODO 自動生成されたメソッド・スタブ
		return false;
	}
